...
<iframe 
  src="https://663a6564311e0ec20c42bab9-xlpxfwvbkd.chromatic.com/iframe.html?args=&id=components-grid--default"  
...
export const GridItemEight: FC<GridProps> = ({ children, className = '' }) => {
  return (
    <div
      className={cn('col-span-12 mb-5 md:col-span-12 lg:col-span-4', className)}
    >
      {children}
    </div>
  );
