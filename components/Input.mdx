...
This component provides input field functionality, allowing users to enter text or data.
...
<Input prop1="value1" prop2="value2" />;
```

<iframe src="https://663a6564311e0ec20c42bab9-xlpxfwvbkd.chromatic.com/iframe.html?args=&id=components-input--default" width="600" height="200"  rounded="12px' className={'flex'}frameborder="0"></iframe>
