...
---
This component provides modal dialog functionality, allowing content to be displayed in a popup window.
...
```tsx
import { Modal } from '@mycrumbs-uikit';

const props = {};

<Modal prop1="value1" prop2="value2" />;
```

<iframe src="https://663a6564311e0ec20c42bab9-xlpxfwvbkd.chromatic.com/iframe.html?args=show:!true&id=components-modal--template" width="600" height="200"  rounded="12px' className={'flex'}frameborder="0"></iframe>
