...
You are now ready to start building your application with MyCrumbs UI Kit. For more information and advanced usage, please refer to the [official documentation](https://www.npmjs.com/package/mycrumbs-uikit).
